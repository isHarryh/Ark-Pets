...
(
    ...
    CONSTRAINT "model_assets_fk_id" FOREIGN KEY ("model_id") REFERENCES "char_info" ("asset_id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
    ...
    "model_id" TEXT    NOT NULL,
    "tag"      TEXT    NOT NULL,
    CONSTRAINT "model_tags_fk_id" FOREIGN KEY ("model_id") REFERENCES "char_info" ("asset_id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
    ...
    "exist"    BOOLEAN NOT NULL DEFAULT FALSE,
    "vcs"      INTEGER NOT NULL DEFAULT 0,
    CONSTRAINT "model_voice_fk_id" FOREIGN KEY ("model_id") REFERENCES "char_info" ("asset_id") ON DELETE CASCADE ON UPDATE CASCADE
);

CREATE TABLE IF NOT EXISTS "model_voice_clips"
(
    "id"             INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
    "model_voice_id" TEXT    NOT NULL,
    "start"          DOUBLE  NOT NULL,
    "duration"       DOUBLE  NOT NULL,
    CONSTRAINT "model_voice_clips_fk_id" FOREIGN KEY ("model_voice_id") REFERENCES "char_info" ("asset_id") ON DELETE CASCADE ON UPDATE CASCADE
);
