...
import cn.harryh.arkpets.render.PostProcessRenderPass;
import cn.harryh.arkpets.render.SpineRenderPass;
...
public class ArkChar {
    ...
    private final SpineRenderPass spineRenderPass;
    ...
    public ArkChar(ArkConfig config, float scale) {
        ...
        spineRenderPass = new SpineRenderPass(camera);
        postProcessRenderPass = new PostProcessRenderPass(camera, config);
    ...
    public void setCanvas(Color bgColor) {
        ...
        postProcessRenderPass.setCanvas(bgColor);
    }
    ...
    public void setOutlineAlpha(float newAlpha) {
        postProcessRenderPass.setOutlineAlpha(newAlpha);
    }
    ...
    public void setOutlineColor(Color color) {
        postProcessRenderPass.setOutlineColor(color);
    }
    ...
    public void setAlpha(float newAlpha) {
        postProcessRenderPass.setAlpha(newAlpha);
    }
    ...
    protected void render() {
        ...
        spineRenderPass.render(skeleton);
    ...
    protected void renderAdditive(float alpha) {
        ...
        skeleton.updateWorldTransform();
        animationState.apply(skeleton);
        spineRenderPass.renderAdditive(skeleton, alpha);
    }
