...
import static cn.harryh.arkpets.platform.X11HWndCtrlFactory.display;
...
public class X11HWndCtrl extends HWndCtrl {
    ...
    static String winText(X11Extension.Window hWnd) {
        String title;
    ...
    static boolean visible(X11.Window hWnd) {
