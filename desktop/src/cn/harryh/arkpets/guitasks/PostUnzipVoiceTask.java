...
public class PostUnzipVoiceTask extends GuiTask {
    private final String rootPath;
    private final String modelsDataPath;

    public PostUnzipVoiceTask(StackPane parent, GuiTaskStyle style) {
        super(parent, style);
        this.rootPath = PathConfig.tempVoiceUnzipDirPath;
        this.modelsDataPath = PathConfig.fileVoiceDataPath;
    }
