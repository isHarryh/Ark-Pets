...
public class DownloadVoiceDatasetTask extends FetchAsFileTask {
    private SourceStrategy.Source selectedSource;

    public DownloadVoiceDatasetTask(StackPane parent, GuiTaskStyle style) {
    ...
    protected URL getTargetURL() {
        selectedSource = SourceStrategy.getStrategy("VoiceDataset").getBestSource();
