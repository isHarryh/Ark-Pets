...
public class DownloadVoicesTask extends FetchAsFileTask {
    private SourceStrategy.Source selectedSource;

    public DownloadVoicesTask(StackPane parent, GuiTaskStyle style) {
    ...
    protected URL getTargetURL() {
        selectedSource = SourceStrategy.getStrategy("VoiceDownload").getBestSource();
